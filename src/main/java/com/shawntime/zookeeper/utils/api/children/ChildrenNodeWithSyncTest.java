 ...
 */
public class ChildrenNodeWithSyncTest implements Watcher {
    ...
    public static void main(String[] args) {
        try {
            zooKeeper = new ZooKeeper("127.0.0.1:2181", 5000, new ChildrenNodeWithSyncTest());
            ...
            List<String> children = zooKeeper.getChildren("/api_node", true);
